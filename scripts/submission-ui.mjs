...
const messages = {
    ...
    transfer: ['申请接收或确认插件所有权转移', 'Request or confirm a plugin ownership transfer', '申請接收或確認外掛所有權移轉', 'プラグイン所有権の受取申請・確認', '플러그인 소유권 인수 요청 또는 확인'],
    ...
    transferReview: ["确认向原申请 PR 提交此决定？","Submit this decision on the original PR?","確認向原申請 PR 提交此決定？","元の PR にこの判断を送信しますか？","원래 PR에 이 결정을 제출할까요?"],
